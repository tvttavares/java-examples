package com.tavares.httprequests.restTemplate.exception.handler;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.tavares.httprequests.restTemplate.exception.RestServiceException;
import com.tavares.httprequests.restTemplate.exception.model.RestTemplateError;
    ...
    public void handleError(ClientHttpResponse response) throws IOException {
        if (response.getStatusCode().is4xxClientError()
            ...
            try (BufferedReader reader = new BufferedReader(new InputStreamReader(response.getBody()))) {
                ...
                throw new RestServiceException(restTemplateError.getPath(), response.getStatusCode(),
